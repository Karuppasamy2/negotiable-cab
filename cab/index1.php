...
<body>
    <nav class="nav">
        ...
        <ul class="sidebar" >
            ...
            <li><a href="book/avail_cabs.php"><h1>AVAILABLE CABS</h1></a></li>
            <li><a href="sample_register.php"><h1>REGISTER</h1></a></li>
            <li><a href="book/booking_status.php"><h1>booking status</h1></a></li>
            <li><a href="driver_login.php"><h1>DRIVER PANEL</h1></a></li>
        ...
        <ul>
            ...
            <li class="hideonmobile"><a href="book/avail_cabs.php"><h1>AVAILABLE CABS</h1></a></li>
            <li class="hideonmobile"><a href="book/booking_status.php"><h1>booking status</h1></a></li>
            <li class="hideonmobile"><a href="sample_register.php"><h1>REGISTER</h1></a></li>
            <li class="hideonmobile"><a href="driver_login.php"><h1>DRIVER PANEL</h1></a></li>
